(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_html2canvas-pro_dist_html2canvas-pro_136ea2.js", {

"[project]/node_modules/html2canvas-pro/dist/html2canvas-pro.js [app-client] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ (function(global, factory) {
    ...
    ***************************************************************************** */ /* global Reflect, Promise */ var extendStatics = function(d, b) {
    ...
    var packLab = function(_context, args) {
        ...
        var _a = extractLabComponents(args), l = _a[0], a = _a[1], b = _a[2], alpha = _a[3], rgb = srgbLinear2rgb(xyz2rgbLinear(lab2xyz([
            l,
            a,
            b
        ])));
    ...
    var packOkLab = function(_context, args) {
        ...
        var _a = extractLabComponents(args), l = _a[0], a = _a[1], b = _a[2], alpha = _a[3], rgb = srgbLinear2rgb(xyz2rgbLinear(oklab2xyz([
            l,
            a,
            b
        ])));
    ...
    var packOkLch = function(_context, args) {
        ...
        var _a = extractOkLchComponents(args), l = _a[0], c = _a[1], h = _a[2], alpha = _a[3], rgb = srgbLinear2rgb(xyz2rgbLinear(oklab2xyz(lch2lab([
            l,
            c,
            h
        ]))));
    ...
    var packLch = function(_context, args) {
        ...
        var _a = extractLchComponents(args), l = _a[0], c = _a[1], h = _a[2], a = _a[3], rgb = srgbLinear2rgb(xyz2rgbLinear(lab2xyz(lch2lab([
            l,
            c,
            h
        ]))));
    ...
    var packHSL = function(context, args) {
        ...
        var _a = extractHslComponents(context, args), h = _a[0], s = _a[1], l = _a[2], a = _a[3], rgb = hsl2rgb([
            h,
            s,
            l
        ]);
    ...
    var extractLabComponents = function(args) {
        var tokens = args.filter(nonFunctionArgSeparator), // eslint-disable-next-line prettier/prettier
        l = tokens[0].type === 16 /* TokenType.PERCENTAGE_TOKEN */  ? tokens[0].number / 100 : isNumberToken(tokens[0]) ? tokens[0].number : 0, // eslint-disable-next-line prettier/prettier
        a = tokens[1].type === 16 /* TokenType.PERCENTAGE_TOKEN */  ? tokens[1].number / 100 : isNumberToken(tokens[1]) ? tokens[1].number : 0, b = isNumberToken(tokens[2]) || isDimensionToken(tokens[2]) ? tokens[2].number : 0, alpha = typeof tokens[4] !== 'undefined' && isLengthPercentage(tokens[4]) ? getAbsoluteValue(tokens[4], 1) : 1;
        return [
            l,
            a,
            b,
    ...
    var extractOkLchComponents = function(args) {
        var tokens = args.filter(nonFunctionArgSeparator), // eslint-disable-next-line prettier/prettier
        l = tokens[0].type === 16 /* TokenType.PERCENTAGE_TOKEN */  ? tokens[0].number / 100 : isNumberToken(tokens[0]) ? tokens[0].number : 0, // eslint-disable-next-line prettier/prettier
        c = tokens[1].type === 16 /* TokenType.PERCENTAGE_TOKEN */  ? tokens[1].number / 100 : isNumberToken(tokens[1]) ? tokens[1].number : 0, h = isNumberToken(tokens[2]) || isDimensionToken(tokens[2]) ? tokens[2].number : 0, a = typeof tokens[4] !== 'undefined' && isLengthPercentage(tokens[4]) ? getAbsoluteValue(tokens[4], 1) : 1;
        return [
            l,
            c,
            h,
     ...
     */ var d65toD50 = function(xyz) {
        return multiplyMatrices(// eslint-disable-next-line prettier/prettier
        [
            1.0479297925449969,
     ...
     */ var oklab2xyz = function(lab) {
        var LMSg = multiplyMatrices(// eslint-disable-next-line prettier/prettier
        [
            1,
            0.3963377773761749,
            0.2158037573099136,
     ...
     */ var rgbToXyz = function(_context, args) {
        ...
        if (tokens.length === 3) {
            var _a = tokens.map(getTokenColorValue), r = _a[0], g = _a[1], b = _a[2], rgb_linear = rgb2rgbLinear([
                r / 255,
                g / 255,
                b / 255
            ]), _b = rgbLinear2xyz([
        ...
        if (tokens.length === 4) {
            var _c = tokens.map(getTokenColorValue), r = _c[0], g = _c[1], b = _c[2], a = _c[3], rgb_linear = rgb2rgbLinear([
                r / 255,
                g / 255,
                b / 255
            ]), _d = rgbLinear2xyz([
     ...
     */ var hslToXyz = function(context, args) {
        var _a = extractHslComponents(context, args), h = _a[0], s = _a[1], l = _a[2], a = _a[3], rgb_linear = rgb2rgbLinear(hsl2rgb([
            h,
            s,
            l
        ])), _b = rgbLinear2xyz([
     ...
     */ var labToXyz = function(_context, args) {
        var _a = extractLabComponents(args), l = _a[0], a = _a[1], b = _a[2], alpha = _a[3], _b = lab2xyz([
            l,
            a,
            b
        ]), x = _b[0], y = _b[1], z = _b[2];
     ...
     */ var lchToXyz = function(_context, args) {
        var _a = extractLchComponents(args), l = _a[0], c = _a[1], h = _a[2], alpha = _a[3], _b = lab2xyz(lch2lab([
            l,
            c,
            h
        ])), x = _b[0], y = _b[1], z = _b[2];
     ...
     */ var oklchToXyz = function(_context, args) {
        var _a = extractOkLchComponents(args), l = _a[0], c = _a[1], h = _a[2], alpha = _a[3], _b = oklab2xyz(lch2lab([
            l,
            c,
            h
        ])), x = _b[0], y = _b[1], z = _b[2];
     ...
     */ var oklabToXyz = function(_context, args) {
        var _a = extractLabComponents(args), l = _a[0], c = _a[1], h = _a[2], alpha = _a[3], _b = oklab2xyz([
            l,
            c,
            h
        ]), x = _b[0], y = _b[1], z = _b[2];
     ...
     */ var srgbFromXYZ = function(args) {
        var _a = srgbLinear2rgb(xyz2rgbLinear([
            args[0],
            args[1],
            args[2]
     ...
     */ var p3FromXYZ = function(args) {
        var _a = p3Linear2p3(xyzToP3Linear([
            args[0],
            args[1],
            args[2]
        ])), r = _a[0], g = _a[1], b = _a[2];
     ...
     */ var a98FromXYZ = function(args) {
        var _a = a98Linear2a98(xyz2a98Linear([
            args[0],
            args[1],
            args[2]
        ])), r = _a[0], g = _a[1], b = _a[2];
     ...
     */ var convertA98rgb = function(args) {
        var srgb_linear = xyz2rgbLinear(a98Linear2xyz(a982a98Linear([
            args[0],
            args[1],
            args[2]
        ])));
     ...
     */ var proPhotoToXYZ = function(args) {
        var prophoto_linear = proPhotoToProPhotoLinear([
            args[0],
            args[1],
            args[2]
        ]);
     ...
     */ var proPhotoFromXYZ = function(args) {
        var _a = proPhotoLinearToProPhoto(xyzToProPhotoLinear(d65toD50([
            args[0],
            args[1],
            args[2]
        ]))), r = _a[0], g = _a[1], b = _a[2];
     ...
     */ var rec2020ToXYZ = function(args) {
        var rec2020_linear = rec20202rec2020Linear([
            args[0],
            args[1],
            args[2]
        ]);
     ...
     */ var rec2020FromXYZ = function(args) {
        var _c = rec2020Linear2rec2020(xyzToRec2020Linear([
            args[0],
            args[1],
            args[2]
     ...
     */ var _color = function(context, args) {
        ...
        if (is_absolute) {
            ...
            var c1 = isNumberToken(tokens[1]) ? tokens[1].number : 0, c2 = isNumberToken(tokens[2]) ? tokens[2].number : 0, c3 = isNumberToken(tokens[3]) ? tokens[3].number : 0, a = tokens.length > 4 && tokens[4].type === 6 /* TokenType.DELIM_TOKEN */  && tokens[4].value === '/' && isNumberToken(tokens[5]) ? tokens[5].number : 1;
            ...
            var extractComponent = function(color, token) {
                ...
                if (token.type === 18 /* TokenType.FUNCTION */ ) {
                    ...
                    if (token.name === 'calc') {
                        var expression = parseCalc(args_1).replace(/r|x/, color[0].toString()).replace(/g|y/, color[1].toString()).replace(/b|z/, color[2].toString());
                        return new Function('return ' + expression)();
                    }
                }
                return null;
            };
            var from_colorspace = tokens[1].type === 18 /* TokenType.FUNCTION */  ? tokens[1].name : isIdentToken(tokens[1]) || tokens[1].type === 5 /* TokenType.HASH_TOKEN */  ? 'rgb' : 'unknown', to_colorspace = isIdentToken(tokens[2]) ? tokens[2].value : 'unknown';
            var from = tokens[1].type === 18 /* TokenType.FUNCTION */  ? tokens[1].values : isIdentToken(tokens[1]) ? [
                tokens[1]
            ] : [];
    ...
    var InputElementContainer = function(_super) {
        ...
        function InputElementContainer(context, input) {
            ...
            if (_this.type === CHECKBOX || _this.type === RADIO) {
                ...
                _this.styles.borderTopStyle = _this.styles.borderRightStyle = _this.styles.borderBottomStyle = _this.styles.borderLeftStyle = 1 /* BORDER_STYLE.SOLID */ ;
                        ...
                        switch(_a.label){
                            case 0:
                                ...
                                if (typeof referenceElement === 'undefined') {
                                    return [
                                        2 /*return*/ ,
                                        Promise.reject("Error finding the ".concat(this.referenceElement.nodeName, " in the cloned document"))
                                    ];
                                }
                ...
                if (token.type === 0 /* TokenType.STRING_TOKEN */ ) {
                    ...
                    if (token.name === 'attr') {
                        ...
                        if (counter && isIdentToken(counter)) {
                            ...
                            var counterType = counterStyle && isIdentToken(counterStyle) ? listStyleType.parse(_this.context, counterStyle.value) : 3 /* LIST_STYLE_TYPE.DECIMAL */ ;
                        ...
                        if (counter && isIdentToken(counter)) {
                            ...
                            var counterType_1 = counterStyle && isIdentToken(counterStyle) ? listStyleType.parse(_this.context, counterStyle.value) : 3 /* LIST_STYLE_TYPE.DECIMAL */ ;
    ...
    var CanvasRenderer = function(_super) {
        ...
        CanvasRenderer.prototype.createFontStyle = function(styles) {
            ...
            var fontSize = isDimensionToken(styles.fontSize) ? "".concat(styles.fontSize.number).concat(styles.fontSize.unit) : "".concat(styles.fontSize.number, "px");
            return [
                [
                    styles.fontStyle,
                    fontVariant,
                ...
                return __generator(this, function(_c) {
                    switch(_c.label){
                        ...
                        case 14:
                            ...
                            if (!contains(container.styles.display, 2048 /* DISPLAY.LIST_ITEM */ )) return [
                                3 /*break*/ ,
                                20
                            ];
                            ...
                            if (!(img.type === 0 /* CSSImageType.URL */ )) return [
                                3 /*break*/ ,
                                18
                            ];
                            image = void 0;
                        ...
                        case 0:
                            ...
                            _loop_1 = function(backgroundImage) {
                                ...
                                return __generator(this, function(_h) {
                                    switch(_h.label){
                                        case 0:
                                            if (!(backgroundImage.type === 0 /* CSSImageType.URL */ )) return [
                                                3 /*break*/ ,
                                                5
                                            ];
                                            image = void 0;
                ...
                return __generator(this, function(_a) {
                    switch(_a.label){
                        ...
                        case 3:
                            ...
                            border = borders_1[_i];
                            if (!(border.style !== 0 /* BORDER_STYLE.NONE */  && !isTransparent(border.color) && border.width > 0)) return [
                                3 /*break*/ ,
                                11
                            ];
                            if (!(border.style === 2 /* BORDER_STYLE.DASHED */ )) return [
                                3 /*break*/ ,
                                5
                            ];
                            return [
                                4 /*yield*/ ,
                                this.renderDashedDottedBorder(border.color, border.width, side, paint.curves, 2 /* BORDER_STYLE.DASHED */ )
                            ];
                        case 4:
                            _a.sent();
                            return [
                        ...
                        case 5:
                            if (!(border.style === 3 /* BORDER_STYLE.DOTTED */ )) return [
                                3 /*break*/ ,
                                7
                            ];
                            return [
                                4 /*yield*/ ,
                                this.renderDashedDottedBorder(border.color, border.width, side, paint.curves, 3 /* BORDER_STYLE.DOTTED */ )
                            ];
                        case 6:
                            _a.sent();
                            return [
                        ...
                        case 7:
                            if (!(border.style === 4 /* BORDER_STYLE.DOUBLE */ )) return [
                                3 /*break*/ ,
                                9
                            ];
                            return [
...
//# sourceMappingURL=node_modules_html2canvas-pro_dist_html2canvas-pro_136ea2.js.map